...
**Como compilar**  
O comando abaixo compila os arquivos `.java` e envia para a pasta `bin`  
<kbd>javac -d bin $(find src -name "*.java")</kbd>

**Como executar**  
Com tudo compilado, com o comando abaixo execute o arquivo HospeDjInn:  
<kbd>java -cp bin HospeDjInn</kbd>
  
![logo](logo/logoHospedagem.png)
